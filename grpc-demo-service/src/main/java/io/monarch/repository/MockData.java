...
public class MockData {
  ...
  public static List<Author> getAuthorsFromTempDb() {
    return List.of(
        Author.newBuilder().setAuthorId(1).setBookId(1).setFirstName("Charles").setLastName("Dickens").setGender("male").build(),
  ...
  public static List<Book> getBooksFromTempDb() {
    return List.of(Book.newBuilder().setBookId(1).setAuthorId(1).setTitle("Oliver Twist").setPrice(123.3f).setPages(100).build(),
